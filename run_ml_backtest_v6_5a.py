#!/usr/bin/env python
"""
v6.5A 激进择时 — 基于v6.4B (年化46.28%, 回撤-30.09%)
...
def run_v6_backtest(start_date='2022-01-01', end_date='2025-12-31'):
    ...
    """
    print("=" * 70)
    print("v6.5A 激进择时 (动态动量池 + ML + 择时 + 宽松回撤熔断)")
    ...
    # 保存结果
    result = {
        'version': 'v6.5a_aggressive_timing',
        'config': {
            'n_stocks': N_STOCKS,
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='v6.5A 激进择时回测')
